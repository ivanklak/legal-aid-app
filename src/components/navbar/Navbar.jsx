            ...
            <ul className={`${navbar_styles.nav_links}`}>
                ...
                <li className={`${isActive ? navbar_styles.showMenu : ''}`}>
                    <div className={`${navbar_styles.icon_link}`}>
                        ...
                        <i className={navbar_styles.navbar_icon + ' ' + navbar_styles.arrow}
                           onClick={clickHandler}><IoIosArrowDown/></i>
                    </div>
                ...
                <li>
                    <div className={`${navbar_styles.profile_details}`}>
                        ...
                        <i className={`${navbar_styles.navbar_icon}`} onClick={clickLogOut}><IoIosLogOut/></i>
                    </div>
                </li>
            </ul>
        </div>
